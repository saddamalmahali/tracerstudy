...
class LaporanRespondenController extends Controller
{
    ...
    public function get_trace_detail_with_jurusan($id_jurusan){
        $alumni = Alumni::where('jurusan', '=', $id_jurusan)->get();
...
//            return json_encode($tracer_detile);
    ...
    public function tracer_detile_with_jurusan($id_form, $id_jurusan, Request $request)
    {
        if($id_form == 'f3')
        {
            $res = [
            ...
            return view('laporan_responden.detile_jurusan', ['res'=>$res]);
        }
        ...
        if($id_form == 'f4'){
            ...
            return view('laporan_responden.detile_f4_with_jurusan', ['res'=>$res]);
        }
        ...
        if($id_form == 'f13'){
            ...
            return view('laporan_responden.detile_f13_with_jurusan', ['res'=>$res]);
        }
        if($id_form == 'f14'){
            $res = [
                'title_panel'=> 'Responden Untuk Form 14',
...
//
    ...
    public function getChartContent2(Request $request)
    {
        $jurusan = $request->get('id_jurusan');
        if($request->get('id_form') == 'f3'){
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f3')->where('option', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f3')->where('option', '=', 2)->count()
            ];
            ...
            return \response($res, 200, ['Content-Type'=>'application/json']);
//            return response(json_encode($this->get_trace_detail_with_jurusan($jurusan)->get()->where('kode_form', '=', 'f3')), 200, ['Content-Type'=>'application/json']);
        } else if($request->get('id_form') == 'f4'){
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 5)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 6)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 7)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 8)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 9)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 10)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 11)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 12)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 13)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 14)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f4')->where('value', '=', 15)->count(),
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f5')->where('option', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f5')->where('option', '=', 2)->count()
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f6')->where('option', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f6')->where('option', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f6')->where('option', '=', 3)->count()
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7')->where('option', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7')->where('option', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7')->where('option', '=', 3)->count()
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7a')->where('option', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7a')->where('option', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f7a')->where('option', '=', 3)->count()
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f8')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f8')->where('value', '=', 0)->count(),
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f9')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f9')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f9')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f9')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f9')->where('value', '=', 5)->count(),
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f10')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f10')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f10')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f10')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f10')->where('value', '=', 5)->count(),
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f11')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f11')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f11')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f11')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f11')->where('value', '=', 5)->count(),
...
//
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 5)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 6)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 7)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 8)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 9)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 10)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 11)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 12)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 13)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 14)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 15)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 16)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 17)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 18)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 19)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 20)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 21)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 22)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 23)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 24)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 25)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 26)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 27)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 28)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 29)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 30)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 31)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 32)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 33)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 34)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 35)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 36)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 37)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 38)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 39)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 40)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 41)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 42)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 43)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 45)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 46)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 47)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 48)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 49)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 50)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 51)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 52)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 53)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 54)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 55)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 56)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 57)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 58)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 59)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 60)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 61)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 62)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 63)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 64)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 65)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 66)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 67)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 68)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 69)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 70)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 71)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 72)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 73)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 74)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 75)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 76)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 77)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 78)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 79)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 80)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 81)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 82)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 83)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 84)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 85)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 86)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 87)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f12')->where('value', '=', 88)->count(),
            ...
            $pokok = [
                ...
                'data'=> [
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_1')->where('value', '<', 2000000)->count(),
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_1')->where('value', '>=', 2000000)->count(),
                ]
            ];
            ...
            $lembur = [
                'label'=> 'Penghasilan Lembur',
                'data'=> [
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_2')->where('value', '<', 2000000)->count(),
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_2')->where('value', '>=', 2000000)->count(),
                ]
            ];
            ...
            $lainnya = [
                'label'=> 'Penghasilan Lainnya',
                'data'=> [
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_3')->where('value', '<', 2000000)->count(),
                    $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f13_3')->where('value', '>=', 2000000)->count(),
                ]
            ];
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f14')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f14')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f14')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f14')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f14')->where('value', '=', 5)->count(),
            ...
            $data_chart = [
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 1)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 2)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 4)->count(),
            ];
            $res = [
                'chart_data'=>$data_chart,
                'chart_head'=>[
            ...
            $data_chart = [
                ...
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 3)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 4)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 5)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 6)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 7)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 8)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 9)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 10)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 11)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 12)->count(),
                $this->get_trace_detail_with_jurusan($jurusan)->where('kode_form', '=', 'f15')->where('value', '=', 13)->count(),
            ];
            $res = [
                'chart_data'=>$data_chart,
                'chart_head'=>[
