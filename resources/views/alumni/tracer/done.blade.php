            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h2 class="box-title"><i class="fa fa-calendar-check-o"></i>&nbsp;&nbsp;TERIMA KASIH ATAS PARTISIPASINYA</h2>
                    </div>
                    <div class="box-body">
                        <h3>Berikut Merupakan Data Isian Anda</h3>
                        <table class='table'>
                            <tr class="bg-primary">
