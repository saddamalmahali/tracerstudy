...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="{{url('/admin/tracer')}}" class="btn btn-warning btn-lg"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                <a href="{{url('/admin/tracer/simpan_update')}}" onclick="event.preventDefault(); document.getElementById('form_update_tracer').submit();" class="btn btn-primary btn-lg"><i class="fa fa-save"></i>&nbsp;&nbsp;Kembali</a>
            </div>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <form action="{{url('/admin/tracer/simpan_update')}}" method="post" id="form_update_tracer">
                    {{csrf_field()}}
                    <input type="hidden" name="id_tracer" value="{{$tracer->id}}">
                    <div class="box box-primary">
                        <div class="box-header">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group{{ $errors->has('f3_input_text') ? ' has-error' : '' }}">
                                            <div class="col-md-2"><input type="number" name="f3_input_text"  value="{{$isian_tracer->where('kode_form', '=', 'f3')->first()->value}}" class="form-control"></div>
                                            <div class="col-md-10">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group {{ $errors->has('f5_input_text') ? ' has-error' : '' }}">
                                            <div class="col-md-2"><input type="number" name="f5_input_text" value="{{$isian_tracer->where('kode_form', '=', 'f5')->first()->value }}" class="form-control"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group {{ $errors->has('f6_input_text') ? ' has-error' : '' }}">
                                            <div class="col-md-2"><input type="number" name="f6_input_text" value="{{$isian_tracer->where('kode_form', '=', 'f6')->first()->value}}" class="form-control"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group {{ $errors->has('f7_input_text') ? ' has-error' : '' }}">
                                            <div class="col-md-2"><input type="number" name="f7_input_text" value="{{$isian_tracer->where('kode_form', '=', 'f7')->first()->value }}" class="form-control"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group{{ $errors->has('f7a_input_text') ? ' has-error' : '' }}">
                                            <div class="col-md-2"><input type="number" name="f7a_input_text" value="{{$isian_tracer->where('kode_form', '=', 'f7a')->first()->value}}" class="form-control"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group{{ $errors->has('f13_pekerjaan_utama') ? ' has-error' : '' }}" >
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control"  value="{{$isian_tracer->where('kode_form', '=', 'f13_1')->first()->value}}" name="f13_pekerjaan_utama" value="1" style="margin-bottom:10px; width:200px;">
                                            </div>
                                        </div>
                                        <div class="form-group{{ $errors->has('f13_pekerjaan_lembur') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control"  value="{{$isian_tracer->where('kode_form', '=', 'f13_2')->first()->value}}" name="f13_pekerjaan_lembur" value="2" style="margin-bottom:10px;width:200px;">
                                            </div>
                                        </div>
                                        <div class="form-group{{ $errors->has('f13_pekerjaan_lainnya') ? ' has-error' : '' }}" style="margin-bottom:10px;">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control"  value="{{$isian_tracer->where('kode_form', '=', 'f13_3')->first()->value}}" name="f13_pekerjaan_lainnya" value="3" style="margin-bottom:10px;width:200px;">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
